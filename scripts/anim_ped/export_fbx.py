...
import sys
sys.path.append('/home/hche/Downloads/fbx202032_fbxpythonsdk_linux/lib/Python37_x64')
...
def SaveSceneBinary(pSdkManager, pScene, pFilename, pFileFormat = -1, pEmbedMedia = False):
...
if __name__ == "__main__":
    ...
    root_dir = './'
    mesh_dir = os.path.join(root_dir, 'ply_files')
    pose_dir = os.path.join(root_dir, 'poses')
    save_dir = os.path.join(root_dir, 'fbx_files')
    ...
    # ==============================================================================
        ...
        # Save the scene
        lResult = SaveSceneBinary(lSdkManager, lScene, os.path.join(save_dir, f"{smpl_object['name']}.fbx"))
